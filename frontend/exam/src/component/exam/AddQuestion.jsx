...
export default class AddQuestion extends Component {
    ...
    submitPage = (event) => {
        ...
        QuestionApiServices.createQuestion(questionDTO).then(
            response => {
                console.log(response);
                if (response.status === 200) {
                    return this.props.history.push("/added")
                }
            }
        )
    }
                    ...
                    <div className="row">
                        <div className="card col-6 mx-auto mt-3 shadow p-4">
                            ...
                            <div className='form-group mt-3 float-end mx-auto'>
                                ...
                                <button className="btn btn-outline-primary me-3" onClick={() => this.submitPage()}>Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
